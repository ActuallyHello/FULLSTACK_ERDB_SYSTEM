<template>
    <div>
        ...
        <div class="buttons">
            ...
            <button class="button mt-2" @click="editTable">
                <span class="icon">
...
export default {
    ...
    props: ['tables', 'editTableId', 'editTableMaxId', 'editTableTitle', 'editTablePKFields', 'editTableFKFields', 'editTableAttrFields'],
    components: {
        PrimaryKeyRow,
        ForeignKeyRow,
        AttributeRow
    ...
    data() {
        return {
            id: this.editTableMaxId + 1,
            
            tableId: this.editTableId,
            tableTitle: this.editTableTitle,
            fkSelectedPower: '',

            pkFieldsMap: this.editTablePKFields,
            fkFieldsMap: this.editTableFKFields,
            attrFieldsMap: this.editTableAttrFields,
        }
    },
    methods: {
        ...
        editTable() {
            ...
            this.$emit('editTable', this.tableId, {
